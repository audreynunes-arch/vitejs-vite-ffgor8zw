        ...
        >
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                updateDefunt('precision_naissance', e.target.value)
              }
              style={inputStyle}
            >
            ...
            {(defunt.precision_naissance || 'complete') === 'complete' ? (
              ...
              <input
                ...
                onChange={(e) =>
                  updateDefunt(
                    'date_naissance',
                    e.target.value.length === 4 ? e.target.value + '-01-01' : ''
                  )
                }
                style={inputStyle}
              />
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => updateDefunt('lien_conjoint', e.target.value)}
              style={inputStyle}
            >
